...
public class Principal {
	...
	public static void main(String[] args) {
		...
		textos.addAll(lerArquivo.carregarTextos("textos/policia/treino", TipoTexto.TREINO, CategoriaTexto.POLICIA)); //** ERRO BOW - indexoutofbounds
		textos.addAll(lerArquivo.carregarTextos("textos/problema/treino", TipoTexto.TREINO, CategoriaTexto.PROBLEMA)); //** ERRO BOW - indexoutofbounds
		textos.addAll(lerArquivo.carregarTextos("textos/trabalhador/treino", TipoTexto.TREINO, CategoriaTexto.TRABALHADOR));

		System.out.println("Dados dos textos");
