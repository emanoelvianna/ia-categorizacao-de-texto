...
public class Principal {
	...
	public static void main(String[] args) {
		...
		textos.addAll(lerArquivo.carregarTextos("textos/trabalhador/treino", TipoTexto.TREINO, CategoriaTexto.POLICIA));
		...
		/* Textos de testes */
		textos.addAll(lerArquivo.carregarTextos("textos/trabalhador/teste", TipoTexto.TESTE, CategoriaTexto.POLICIA));
